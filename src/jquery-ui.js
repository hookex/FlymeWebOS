...
(function(c, d) {
	...
	c.widget("ui.resizable", c.ui.mouse, {
		...
		_mouseDrag: function(e) {
			var k, g = this.helper,
				l = {}, i = this.originalMousePosition,
				m = this.axis,
				o = this.position.top,
				...
				k = {
					...
					c(m).each(function() {
						var q = c(this),
							...
							p = {}, o = n && n.length ? n : q.parents(i.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
	...
	d.widget("ui.accordion", {
		...
		_animate: function(f, n, j) {
			var m, l, i, k = this,
				...
				h = this.options.animate || {}, q = p && h.down || h,
				g = function() {
					k._toggleComplete(j)
				};
			if (typeof q === "number") {
	...
	b.widget("ui.slider", b.ui.mouse, {
		...
		_createHandles: function() {
			var g, d, e = this.options,
				...
				h = "<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'><i></i><em></em></a>",
				f = [];
